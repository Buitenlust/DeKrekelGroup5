...
namespace DeKrekelGroup5.Controllers
{
    public class BoekenController : Controller
    {
        ...
        {
            letterTuin = new LetterTuin(){BoekenRepository = boekenRepository, ThemasRepository = themasRepository};
            beheerder = new Beheerder(){ BoekenRepository = boekenRepository, ThemasRepository = themasRepository };
        }
